...
var fight = function(enemyName) {
    ...
    //   OLD CODE enemyHealth = Math.max(0, enemyHealth - playerAttack);
      ...
      // OLD CODE playerHealth = Math.max(0, playerHealth - enemyAttack);
...
var shop = function() {
    ...
    var shopOptionPrompt = window.prompt(
        "Would you like to REFILL your health, UPGRADE your attack, or LEAVE the shop? Enter: 'REFILL' 'UPGRADE' or 'LEAVE' to make a choice."
    );
